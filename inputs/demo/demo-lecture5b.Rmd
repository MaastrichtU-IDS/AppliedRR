...
logitmodel <- glm(formula = admit ~ stats, # dependent variable ~ indepedent variable
...
### Exercise 1 – Now it is your turn: Using the previous explained steps, run a simple logistic regression model using responsible score as the independent variable and admit as the dependent variable. Interpret the results.
