...
### Exercise 4: Conduct a regression analysis predicting a player’s Salary as a function of the following **independent variables**. Save the result to an object called baseball_multiple and ask R to give you the output (which should look like below).
